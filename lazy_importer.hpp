...
namespace li { namespace detail {
    ...
    namespace win {
        using ::IMAGE_DOS_HEADER;
        using ::IMAGE_FILE_HEADER;
        using ::IMAGE_EXPORT_DIRECTORY;
        using ::IMAGE_DATA_DIRECTORY;
        using ::IMAGE_NT_HEADERS;
    ...
    struct hash_t {
        ...
        LAZY_IMPORTER_FORCEINLINE constexpr static value_type
        single(value_type value, char c) noexcept
        {
    ...
    LAZY_IMPORTER_FORCEINLINE std::pair<hash_t::value_type, hash_t::value_type> hash_forwarded(
